...
class UserTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_type" do
    assert_difference('UserType.count') do
      post user_types_url, params: { user_type: { description: @user_type.description, name: @user_type.name, state: @user_type.state } }
    end
  ...
  test "should update user_type" do
    patch user_type_url(@user_type), params: { user_type: { description: @user_type.description, name: @user_type.name, state: @user_type.state } }
